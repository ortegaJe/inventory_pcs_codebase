        ...
        <div class="js-wizard-simple block">
            ...
            <div class="alert alert-{{ Session::get('typealert') }} alert-dismissible fade show" style="d-none">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <div class="form-material floating input-group">
                                    <input type="text" class="form-control" id="serial-monitor-pc"
                                        name="serial-monitor-pc" maxlength="24" value="{{ old('serial-monitor-pc') }}"
                                        onkeyup="javascript:this.value=this.value.toUpperCase();">
                            ...
                            <div class="col-md-4">
                                <div class="form-material floating input-group">
                                    <input type="text" class="form-control" id="pc-domain-name" name="pc-domain-name"
                                        maxlength="20" value="{{ old('pc-domain-name') }}"
                                        onkeyup="javascript:this.value=this.value.toUpperCase();">
                            ...
                            <div class="col-md-9">
                                <div class="form-material floating input-group">
                                    <input type="text" class="form-control" id="custodian-name" name="custodian-name"
                                        maxlength="56" value="{{ old('custodian-name') }}"
                                        onkeyup="javascript:this.value=this.value.toUpperCase();">
                            ...
                            <div class="col-md-12">
                                <div class="form-material">
                                    <textarea class="js-maxlength form-control" id="observation" name="observation"
                                        ...
                                        data-limit-reached-class="badge badge-warning"
