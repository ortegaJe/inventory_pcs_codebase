...
@section('title', 'Temporal Dashboard')
...
<script>
    let root_url_desktop = <?php echo json_encode(route('admin.inventory.campu.temporal.index')) ?>;
  let root_url_desktop_store = <?php echo json_encode(route('admin.inventory.campu.temporal.store')) ?>;
</script>
@endpush