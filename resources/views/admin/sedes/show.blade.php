          ...
          <div class="col-4">
            <div class="form-material floating">
              <input type="text" class="form-control" id="address" name="address"
                onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{ trim($campus->address) }}">
          ...
          <div class="col-4">
            <div class="form-material floating">
              <input type="text" class="form-control" id="phone" name="phone"
                onkeyup="javascript:this.value=this.value.toUpperCase();" value="{{ trim($campus->phone) }}">
