...
<div class="col-md-6 col-xl-2">
  <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
    <div class="block-content block-content-full block-sticky-options">
      ...
      <div class="py-20 text-center">
        <div class="font-size-h2 font-w700 mb-0 text-flat" data-toggle="countTo" data-to="{{ $globalLaptopPcCount }}">0
        </div>
...
<script>
  let root_url_desktop = <?php echo json_encode(route('tec.inventory.desktop.index')) ?>;
  let root_url_desktop_store = <?php echo json_encode(route('tec.inventory.desktop.store')) ?>;
</script>
@endpush