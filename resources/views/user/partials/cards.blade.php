    ...
    <div class="col-md-6 col-xl-2">
        <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
            <div class="block-content block-content-full block-sticky-options">
                <div class="block-options">
                    <div class="block-options-item">
                        <img width="30px" src="{{ asset('media/various/raspberry-pi-0.svg') }}"
                            alt="raspberry-pi.svg">
                    </div>
                </div>
                <div class="py-20 text-center">
    ...
    <div class="col-md-6 col-xl-2">
        <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
            <div class="block-content block-content-full block-sticky-options">
                <div class="block-options">
                    <div class="block-options-item">
                        <img style="opacity: 0.5;" width="30px" src="{{ asset('media/various/enrutador.png') }}"
                            alt="enrutador.png">
                    </div>
                </div>
                <div class="py-20 text-center">
    ...
    <div class="col-md-6 col-xl-2">
        <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
            <div class="block-content block-content-full block-sticky-options">
                <div class="block-options">
                    <div class="block-options-item">
                        <i class="fa fa-tablet fa-2x text-primary-light"></i>
                    </div>
                </div>
                <div class="py-20 text-center">
                    <div class="font-size-h2 font-w700 mb-0 text-primary" data-toggle="countTo"
                        data-to="{{ $globalTabletCount }}">
                        0
                    </div>
                    <div class="font-size-sm font-w600 text-uppercase text-muted">Tablet</div>
                </div>
            </div>
        </a>
    </div>
