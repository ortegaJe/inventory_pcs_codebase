...
<div class="row">
    <div class="col-md-12 mx-auto">
        <h2 class="content-heading">Actualizar Equipo All In One</h2>
      ...
      data-message="Update failed! :-(">Error</button> --}}
        ...
        <div class="js-wizard-simple block">
            ...
            <!-- Form -->
            <form action="{{ route('user.inventory.allinone.update', $pcs->id) }}" method="POST">
                @csrf
                @method('PATCH')
                <!-- Steps Content -->
                <div class="block-content block-content-full tab-content" style="min-height: 274px;">
                    ...
                    <div class="tab-pane active" id="wizard-progress2-step1" role="tabpanel">
                        ...
                        <div data-notify="container"
                            ...
                            <button type="button" aria-hidden="true" class="close" data-notify="dismiss"
                                style="position: absolute; right: 10px; top: 5px; z-index: 1035;">×</button><span
                                data-notify="icon" class="fa fa-times"></span> <span data-notify="title"></span> <span
                                ...
                                <div class="form-material">
                                    <select class="js-select2 form-control" id="marca-pc-select2"
                                        ...
                                        <option value="{{ $brand->id }}"
                                            {{ $brand->id == $pcs->brand_id ? 'selected' : '' }}>
                                            {{ $brand->name }}</option>
                                        @empty
                            ...
                            <div class="col-md-3">
                                <div class="form-material">
                                    <select class="js-select2 form-control" id="val-select2-ram0"
                                        ...
                                        <option value="{{ $ram->id }}">
                                        <option value="{{ $ram->id }}"
                                            {{ $ram->id == $pcs->slot_one_ram_id ? 'selected' : '' }}>
                                ...
                                <div class="form-material">
                                    <select class="js-select2 form-control" id="val-select2-first-storage"
                                        ...
                                        <option value="{{ $storage->id }}"
                                            {{ $storage->id == $pcs->first_storage_id ? 'selected' : '' }}>
                                            {{ $storage->size }}
                            ...
                            <div class="col-md-6">
                                <div class="form-material">
                                    <select class="js-select2 form-control" id="val-select2-cpu" name="val-select2-cpu"
                                        ...
                                        <option value="{{ $cpu->id }}"
                                            {{ $cpu->id == $pcs->processor_id ? 'selected' : '' }}>
                                            {{ $cpu->brand }}
                                            {{ $cpu->generation }}
                                            {{ $cpu->velocity }}
                                        </option>
                    ...
                    <div class="tab-pane" id="wizard-progress2-step3" role="tabpanel">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <div class="form-material floating input-group">
                                    <input type="text" class="form-control" id="pc-domain-name" name="pc-domain-name"
                                        maxlength="20" value="{{ $pcs->pc_name_domain }}"
                                        onkeyup="javascript:this.value=this.value.toUpperCase();">
                    ...
                    <div class="tab-pane" id="wizard-progress2-step4" role="tabpanel">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                <div class="form-material">
                                    <input type="text" class="js-flatpickr form-control" id="custodian-assignment-date"
                                        name="custodian-assignment-date" placeholder="d-m-Y" data-allow-input="true"
                                        maxlength="10" value="{{ $pcs->custodian_assignment_date }}">
                            ...
                            <div class="col-md-9">
                                <div class="form-material floating input-group">
                                    <input type="text" class="form-control" id="custodian-name" name="custodian-name"
                                        maxlength="56" value="{{ $pcs->custodian_name }}"
                                        onkeyup="javascript:this.value=this.value.toUpperCase();">
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="form-material">
                                    <textarea class="js-maxlength form-control" id="observation" name="observation"
                                        rows="3" maxlength="255" placeholder="Escriba aqui una observación"
                                        data-always-show="true" data-warning-class="badge badge-primary"
