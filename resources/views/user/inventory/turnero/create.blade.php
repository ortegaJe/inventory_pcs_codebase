...
@section('content')
    <div class="row">
        <div class="col-md-12 mx-auto">
            <h2 class="content-heading">Registrar Nuevo Atril</h2>
            @if ($errors->any())
            ...
            <div class="js-wizard-simple block">
                ...
                <!-- Form -->
                <form id="uploadForm" action="{{ route('user.inventory.turnero.store') }}" method="POST"
                    ...
                    <div class="block-content block-content-full tab-content" style="min-height: 274px;">
                        ...
                        <div class="tab-pane active" id="wizard-progress2-step1" role="tabpanel">
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-material">
                                        <select class="js-select2 form-control" id="os" name="os"
                                            style="width: 100%;" data-placeholder="Seleccionar sistema operativo..">
                                            <option disabled selected></option>
                                            <!-- Empty value for demostrating material select box -->
                                            @forelse ($operatingSystems as $os)
                                                @if (old('os') == $os->id)
                                                    <option value="{{ $os->id }}" selected>{{ $os->name }}
                                                        {{ $os->version }} {{ $os->architecture }}
                                                    </option>
                                                @else
                                                    <option value="{{ $os->id }}">{{ $os->name }}
                                                        {{ $os->version }} {{ $os->architecture }}</option>
                                                @endif
                                            @empty
                        ...
                        <div class="tab-pane" id="wizard-progress2-step2" role="tabpanel">
                                    ...
                                    <div class="form-material">
                                        <select class="js-select2 form-control" id="ram0" name="ram0"
                                            ...
                                            @forelse ($memoryRams as $ram)
                                                @if (old('ram0') == $ram->id)
                                                    <option value="{{ $ram->id }}" selected>
                                                        {{ $ram->size }}{{ $ram->storage_unit }}{{ $ram->type }}
                                                        {{ $ram->format }}
                                                    </option>
                                                @else
                                                    <option value="{{ $ram->id }}">
                                        ...
                                        <select class="js-select2 form-control" id="hdd0" name="hdd0"
                                            ...
                                            @forelse ($storages as $storage)
                                                @if (old('hdd0') == $storage->id)
                                                    <option value="{{ $storage->id }}" selected>{{ $storage->size }}
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <div class="form-material">
                                        <select class="js-select2 form-control" id="processor" name="processor"
                                            style="width: 100%;" data-placeholder="Seleccionar procesador..">
                                            <option disabled selected></option>
                                            <!-- Empty value for demostrating material select box -->
                                            @forelse ($processors as $cpu)
                                                @if (old('processor') == $cpu->id)
                                                    <option value="{{ $cpu->id }}" selected>{{ $cpu->brand }}
                                                        {{ $cpu->generation }}
                                                        {{ $cpu->velocity }}
                                                    </option>
                                                @else
                                                    <option value="{{ $cpu->id }}">{{ $cpu->brand }}
                                                        {{ $cpu->generation }}
                                                        {{ $cpu->velocity }}
                                                    </option>
                                                @endif
                                ...
                                <div class="col-md-6">
                                    <div class="form-material">
                                        <select class="js-select2 form-control" id="statu" name="statu"
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    <div class="form-material floating input-group">
                                        <input type="text" class="form-control" id="anydesk" name="anydesk"
                                            maxlength="24" value="{{ old('anydesk') }}"
                                            onkeyup="javascript:this.value=this.value.toUpperCase();">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-material">
                                            <select class="js-select2 form-control" id="domain_name" name="domain_name"
                                ...
                                <div class="col-md-4">
                                    <div class="form-material floating">
                                        <input type="text" class="form-control" id="device_name" name="device_name"
                                            maxlength="20" onkeypress="return /[0-9a-zA-Z-]/i.test(event.key)"
                        ...
                        <div class="tab-pane" id="wizard-progress2-step4" role="tabpanel">
                                            ...
                                            <select class="js-select2 form-control" id="campu" name="campu"
                                                ...
                                                @forelse ($campus as $campu)
                                                    @if (old('campu') == $campu->id)
                                                        <option value="{{ $campu->id }}" selected>{{ $campu->name }}
                                                        </option>
                                                    @else
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <div class="form-material">
                                        <input type="text" class="js-flatpickr form-control" id="custodian_date"
                                            name="custodian_date" placeholder="d-m-Y" data-allow-input="true"
                                            maxlength="10">
                                ...
                                <div class="col-md-6">
                                    <div class="form-material floating input-group">
                                        <input type="text" class="form-control" id="custodian_name"
                                            name="custodian_name" maxlength="56" value="{{ old('custodian_name') }}"
                                            onkeypress="return /[0-9a-zA-ZñÑóÓíÍ. ]/i.test(event.key)"
                                            onkeyup="javascript:this.value=this.value.toUpperCase();">
                                ...
                                <div class="col-md-3">
                                    <div class="form-material">
                                        <select class="js-select2 form-control" id="statu_assignment"
                                            name="statu_assignment" style="width: 100%;"
                                ...
                                <div class="col-md-12">
                                    <div class="form-material">
                                        <textarea class="js-maxlength form-control" id="observation" name="observation" rows="3" maxlength="255"
                                            ...
                                            data-limit-reached-class="badge badge-warning" value="{{ old('observation') }}"
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-material">
                                        <label for=""><code>*Se deben subir dos evidencia fotográficas del atril instalado y etiqueta del serial.</code></label>
    ...
    <h2 class="content-heading d-none">Cargar Evidencia Fotografica</h2>
    <div class="block d-none">
        <div class="block-content block-content-full">
            <p>Se requiere cargar dos fotos del Atril: Etiqueta del serial y fotografia del Atril instalado.
                <code>.table-hover</code>
            </p>
            <!-- DropzoneJS Container -->
            <form class="dropzone" action="{{ route('atril.dropzone.store') }}" method="post"
