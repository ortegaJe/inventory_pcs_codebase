...
@section('content')
    <div class="row">
        <div class="col-md-12 mx-auto">
            <h2 class="content-heading">Registrar Nuevo Equipo Mini Pc SAT</h2>
            @if ($errors->any())
            ...
            <div class="js-wizard-simple block">
                ...
                <!-- Form -->
                <form action="{{ route('minipc.store') }}" method="POST">
                    @csrf
                    @method('POST')
                    <!-- Steps Content -->
                    <div class="block-content block-content-full tab-content" style="min-height: 274px;">
                        ...
                        <div class="tab-pane active" id="wizard-progress2-step1" role="tabpanel">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-material floating input-group">
                                        <input type="text" class="form-control" id="fixed_asset_number"
                                            name="fixed_asset_number" value="{{ old('fixed_asset_number') }}"
                                            onkeyup="javascript:this.value=this.value.toUpperCase();">
                                ...
                                <div class="col-md-3">
                                    <div class="form-material">
                                        <input type="text" class="js-flatpickr form-control" id="custodian_date"
                                            name="custodian_date" value="{{ old('custodian_date') }}"
