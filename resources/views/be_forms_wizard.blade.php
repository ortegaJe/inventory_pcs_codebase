                    ...
                    <ul class="nav-main">
                        ...
                        <li>
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-badge"></i><span
                                    class="sidebar-mini-hide">Page Kits</span></a>
                            <ul>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="be_pages_dashboard2.html"><span class="sidebar-mini-hide">Dashboard
                                                    2</span></a>
                                        </li>
                                        <li>
                                            <a href="be_pages_dashboard3.html"><span class="sidebar-mini-hide">Dashboard
                                                    3</span></a>
                                        </li>
                                        <li>
                                            <a href="be_pages_dashboard4.html"><span class="sidebar-mini-hide">Dashboard
                                                    4</span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><span
                                            class="sidebar-mini-hide">Hosting</span></a>
                                    <ul>
                                        <li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><span
                                            class="sidebar-mini-hide">Real Estate</span></a>
                                    <ul>
                                        <li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><span
                                            class="sidebar-mini-hide">Crypto</span></a>
                                    <ul>
                                        <li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><span
                                            class="sidebar-mini-hide">Alternative Dashboards</span></a>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            <a href="db_corporate.html"><span
                                                    class="sidebar-mini-hide">Corporate</span></a>
                                        </li>
                                        <li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><span
                                            class="sidebar-mini-hide">Boxed Backend</span></a>
                                    <ul>
                                        <li>
                        ...
                        <li>
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-puzzle"></i><span
                                    class="sidebar-mini-hide">Blocks</span></a>
                            <ul>
                                <li>
                        ...
                        <li>
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i
                                    class="si si-moustache"></i><span class="sidebar-mini-hide">Widgets</span></a>
                            <ul>
                                <li>
                        ...
                        <li>
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-energy"></i><span
                                    class="sidebar-mini-hide">Elements</span></a>
                            <ul>
                                <li>
                        ...
                        <li>
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-layers"></i><span
                                    class="sidebar-mini-hide">Tables</span></a>
                            <ul>
                                <li>
                        ...
                        <li class="open">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a class="active" href="be_forms_wizard.html">Wizard</a>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="be_layout_header_fixed_classic_inverse.html">Classic
                                                        Inverse</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="be_layout_header_fixed_glass_inverse.html">Glass
                                                        Inverse</a>
                                                </li>
                                            </ul>
                                        </li>
                        ...
                        <li>
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-trophy"></i><span
                                    class="sidebar-mini-hide">Components</span></a>
                            <ul>
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><span
                                            class="sidebar-mini-hide">Main Menu</span></a>
                                    <ul>
                                        <li>
                                            <a href="#">Link 1-1</a>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#">Sub Level
                                                        3</a>
                                                    <ul>
                                                        <li>
                                                            <a href="#">Link 3-1</a>
                        ...
                        <li>
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i
                                    class="si si-globe-alt"></i><span class="sidebar-mini-hide">Generic</span></a>
                            <ul>
                                <li>
                        ...
                        <li>
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-lock"></i><span
                                    class="sidebar-mini-hide">Authentication</span></a>
                            <ul>
                                <li>
                        ...
                        <li>
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-flag"></i><span
                                    class="sidebar-mini-hide">Error</span></a>
                            <ul>
                                <li>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="js-wizard-simple block">
                            ...
                            <ul class="nav nav-tabs nav-tabs-block nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#wizard-simple-step1" data-toggle="tab">1.
                                        Personal</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="block-content block-content-full tab-content" style="min-height: 265px;">
                                    ...
                                    <div class="tab-pane active" id="wizard-simple-step1" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="wizard-simple-firstname"
                                                name="wizard-simple-firstname">
                                        </div>
                                        <div class="form-group">
                                            <label for="wizard-simple-lastname">Last Name</label>
                                            <input class="form-control" type="text" id="wizard-simple-lastname"
                                                name="wizard-simple-lastname">
                                        </div>
                                        <div class="form-group">
                                            <label for="wizard-simple-email">Email</label>
                                            <input class="form-control" type="email" id="wizard-simple-email"
                                                name="wizard-simple-email">
                                        </div>
                                    </div>
                                    <!-- END Step 1 -->
                                    ...
                                    <div class="tab-pane" id="wizard-simple-step2" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="wizard-simple-bio"
                                                name="wizard-simple-bio" rows="9"></textarea>
                                        </div>
                                    </div>
                                    <!-- END Step 2 -->
                                    ...
                                    <div class="tab-pane" id="wizard-simple-step3" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="wizard-simple-location"
                                                name="wizard-simple-location">
                                        </div>
                                        <div class="form-group">
                                            <label for="wizard-simple-skills">Skills</label>
                                            <select class="form-control" id="wizard-simple-skills"
                                                name="wizard-simple-skills" size="1">
                                        ...
                                        <div class="form-group">
                                            <label class="css-control css-control-primary css-switch"
                                                for="wizard-simple-terms">
                                                <input type="checkbox" class="css-control-input"
                                                    id="wizard-simple-terms" name="wizard-simple-terms">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="js-wizard-simple block">
                            ...
                            <ul class="nav nav-tabs nav-tabs-alt nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#wizard-simple2-step1" data-toggle="tab">1.
                                        Personal</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <form action="be_forms_wizard.html" method="post">
                                ...
                                <div class="block-content block-content-full tab-content" style="min-height: 267px;">
                                    ...
                                    <div class="tab-pane active" id="wizard-simple2-step1" role="tabpanel">
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <input class="form-control" type="text" id="wizard-simple2-firstname"
                                                    name="wizard-simple2-firstname">
                                                <label for="wizard-simple2-firstname">First Name</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <input class="form-control" type="text" id="wizard-simple2-lastname"
                                                    name="wizard-simple2-lastname">
                                                <label for="wizard-simple2-lastname">Last Name</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <input class="form-control" type="email" id="wizard-simple2-email"
                                                    name="wizard-simple2-email">
                                    ...
                                    <div class="tab-pane" id="wizard-simple2-step2" role="tabpanel">
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <textarea class="form-control" id="wizard-simple2-bio"
                                                    name="wizard-simple2-bio" rows="9"></textarea>
                                    ...
                                    <div class="tab-pane" id="wizard-simple2-step3" role="tabpanel">
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <input class="form-control" type="text" id="wizard-simple2-location"
                                        ...
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <select class="form-control" id="wizard-simple2-skills"
                                                    name="wizard-simple2-skills" size="1">
                                                    <option></option>
                                        ...
                                        <div class="form-group">
                                            <label class="css-control css-control-primary css-switch"
                                                ...
                                                <input type="checkbox" class="css-control-input"
                                                    id="wizard-simple2-terms" name="wizard-simple2-terms">
                                                <span class="css-control-indicator"></span> Agree with the terms
                                            </label>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="js-wizard-simple block">
                            ...
                            <ul class="nav nav-tabs nav-tabs-block nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#wizard-progress-step1" data-toggle="tab">1.
                                        Personal</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="block-content block-content-full tab-content" style="min-height: 265px;">
                                    ...
                                    <div class="tab-pane active" id="wizard-progress-step1" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="wizard-progress-firstname"
                                                name="wizard-progress-firstname">
                                        </div>
                                        <div class="form-group">
                                            <label for="wizard-progress-lastname">Last Name</label>
                                            <input class="form-control" type="text" id="wizard-progress-lastname"
                                    ...
                                    <div class="tab-pane" id="wizard-progress-step2" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="wizard-progress-bio"
                                                name="wizard-progress-bio" rows="9"></textarea>
                                        </div>
                                    </div>
                                    <!-- END Step 2 -->
                                    ...
                                    <div class="tab-pane" id="wizard-progress-step3" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="wizard-progress-location"
                                                name="wizard-progress-location">
                                        </div>
                                        <div class="form-group">
                                            <label for="wizard-progress-skills">Skills</label>
                                            <select class="form-control" id="wizard-progress-skills"
                                                name="wizard-progress-skills" size="1">
                                                <option value="">Please select your best skill</option>
                                                <option value="1">Photoshop</option>
                                                <option value="2">HTML</option>
                                                <option value="3">CSS</option>
                                        ...
                                        <div class="form-group">
                                            <label class="css-control css-control-primary css-switch"
                                                ...
                                                <input type="checkbox" class="css-control-input"
                                                    id="wizard-progress-terms" name="wizard-progress-terms">
                                                <span class="css-control-indicator"></span> Agree with the terms
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <form action="be_forms_wizard.html" method="post">
                                ...
                                <div class="block-content block-content-full tab-content" style="min-height: 274px;">
                                    ...
                                    <div class="tab-pane active" id="wizard-progress2-step1" role="tabpanel">
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <input class="form-control" type="text" id="wizard-progress2-firstname"
                                        ...
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <input class="form-control" type="text" id="wizard-progress2-lastname"
                                        ...
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <input class="form-control" type="email" id="wizard-progress2-email"
                                    ...
                                    <div class="tab-pane" id="wizard-progress2-step2" role="tabpanel">
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <textarea class="form-control" id="wizard-progress2-bio"
                                                    name="wizard-progress2-bio" rows="9"></textarea>
                                    ...
                                    <div class="tab-pane" id="wizard-progress2-step3" role="tabpanel">
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <input class="form-control" type="text" id="wizard-progress2-location"
                                                    name="wizard-simple2-location">
                                                <label for="wizard-simple2-location">Location</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <select class="form-control" id="wizard-progress2-skills"
                                        ...
                                        <div class="form-group">
                                            <label class="css-control css-control-primary css-switch"
                                                ...
                                                <input type="checkbox" class="css-control-input"
                                                    id="wizard-progress2-terms" name="wizard-progress2-terms">
                                                <span class="css-control-indicator"></span> Agree with the terms
                                            </label>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="js-wizard-validation-classic block">
                            ...
                            <ul class="nav nav-tabs nav-tabs-block nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#wizard-validation-classic-step1"
                                        data-toggle="tab">1. Personal</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#wizard-validation-classic-step2" data-toggle="tab">2.
                                        Details</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#wizard-validation-classic-step3" data-toggle="tab">3.
                                        Extra</a>
                                </li>
                            </ul>
                            <!-- END Step Tabs -->
                                ...
                                <div class="block-content block-content-full tab-content" style="min-height: 265px;">
                                    ...
                                    <div class="tab-pane active" id="wizard-validation-classic-step1" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"
                                                id="wizard-validation-classic-firstname"
                                                name="wizard-validation-classic-firstname">
                                        </div>
                                        <div class="form-group">
                                            <label for="wizard-validation-classic-lastname">Last Name</label>
                                            <input class="form-control" type="text"
                                                id="wizard-validation-classic-lastname"
                                                name="wizard-validation-classic-lastname">
                                        </div>
                                        <div class="form-group">
                                            <label for="wizard-validation-classic-email">Email</label>
                                            <input class="form-control" type="email"
                                                id="wizard-validation-classic-email"
                                                name="wizard-validation-classic-email">
                                        </div>
                                    </div>
                                    <!-- END Step 1 -->
                                    ...
                                    <div class="tab-pane" id="wizard-validation-classic-step2" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="wizard-validation-classic-bio"
                                                name="wizard-validation-classic-bio" rows="9"></textarea>
                                        </div>
                                    </div>
                                    <!-- END Step 2 -->
                                    ...
                                    <div class="tab-pane" id="wizard-validation-classic-step3" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"
                                                id="wizard-validation-classic-location"
                                                name="wizard-validation-classic-location">
                                        </div>
                                        <div class="form-group">
                                            <label for="wizard-validation-classic-skills">Skills</label>
                                            <select class="form-control" id="wizard-validation-classic-skills"
                                                name="wizard-validation-classic-skills" size="1">
                                                <option value="">Please select your best skill</option>
                                                <option value="1">Photoshop</option>
                                                <option value="2">HTML</option>
                                                <option value="3">CSS</option>
                                        ...
                                        <div class="form-group">
                                            <label class="css-control css-control-primary css-switch"
                                                for="wizard-validation-classic-terms">
                                                <input type="checkbox" class="css-control-input"
                                                    id="wizard-validation-classic-terms"
                                                    name="wizard-validation-classic-terms">
                                                <span class="css-control-indicator"></span> Agree with the terms
                                            </label>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="js-wizard-validation-material block">
                            ...
                            <ul class="nav nav-tabs nav-tabs-alt nav-fill" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#wizard-validation-material-step3" data-toggle="tab">3.
                                        Extra</a>
                                </li>
                            </ul>
                            <!-- END Step Tabs -->
                            ...
                            <!-- Form -->
                            <form class="js-wizard-validation-material-form" action="be_forms_wizard.html"
                                method="post">
                                <!-- Steps Content -->
                                <div class="block-content block-content-full tab-content" style="min-height: 267px;">
                                    <!-- Step 1 -->
                                    <div class="tab-pane active" id="wizard-validation-material-step1" role="tabpanel">
                                        ...
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <input class="form-control" type="text"
                                                    id="wizard-validation-material-lastname"
                                        ...
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <input class="form-control" type="email"
                                                    id="wizard-validation-material-email"
                                    ...
                                    <div class="tab-pane" id="wizard-validation-material-step2" role="tabpanel">
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <textarea class="form-control" id="wizard-validation-material-bio"
                                                    name="wizard-validation-material-bio" rows="9"></textarea>
                                    ...
                                    <div class="tab-pane" id="wizard-validation-material-step3" role="tabpanel">
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <input class="form-control" type="text"
                                                    id="wizard-validation-material-location"
                                                    name="wizard-validation-material-location">
                                                <label for="wizard-validation-material-location">Location</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-material floating">
                                                <select class="form-control" id="wizard-validation-material-skills"
                                                    name="wizard-validation-material-skills" size="1">
                                                    <option></option>
                                                    <!-- Empty value for demostrating material select box -->
                                                    <option value="1">Photoshop</option>
                                                    <option value="2">HTML</option>
        ...
        <footer id="page-footer" class="opacity-0">
            <div class="content py-20 font-size-sm clearfix">
                ...
                <div class="float-left">
                    <a class="font-w600" href="https://1.envato.market/95j" target="_blank">Codebase 3.3</a> &copy;
