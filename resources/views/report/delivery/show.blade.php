    ...
    <div class="block-content">
      ...
      <table class="table table-borderless table-striped">
        ...
        <tbody style="font-size: 14px">
          @forelse($reportDeliveries as $repo)
          <tr>
            ...
            <td class="d-none d-sm-table-cell text-center">
              <div class="btn-group">
                ...
                <a class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Imprimir Reporte"
                  @if(Storage::exists('pdf/acta_de_entrega/'.$repo->campu_slug.'/'.$repo->report_code_number.'.pdf'))
                  href="{{Storage::url('pdf/acta_de_entrega/'.$repo->campu_slug.'/'.$repo->report_code_number.'.pdf')}}"
                  @else
                  href="{{ route('report.delivery.generated', [$repo->repo_id, $repo->rowguid]) }}"
                  @endif
                  target="_blank">
...
@if(count($reportDeliveries) > 0)
<div class="block-content">
  @include('report.delivery.partials.modal-upload')
  <div class="content-heading">
    <button type="button" class="btn btn-sm btn-alt-success float-right" data-toggle="modal"
  ...
  <div class="block block-rounded">
    ...
    <div class="block-content">
      ...
      <table class="table table-borderless table-striped">
        ...
        <tbody style="font-size: 14px">
          @forelse($fileUploadReports as $repo)
          <tr>
            <td class="d-none d-sm-table-cell">
              {{ $repo->report_code_number }}
            </td>
...
<script>
  jQuery(function(){ Codebase.helpers(['flatpickr', 'select2']); });
</script>
