...
<div class="block block-rounded">
    <div class="block-content bg-body-light">
        <!-- Search -->
        <form action="{{ route('inventory.report.removes.index')}}" method="GET">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <button type="button" class="btn btn-sm btn-secondary ml-2" data-toggle="tooltip"
                        data-placement="top" title="Actualizar lista"
                        onclick="window.location='{{ route('inventory.report.removes.index') }}'">
                ...
                @if(count($devices) <= 0) <tr>
                    <td colspan="7" class="text-center">SERIAL NO ENCONTRADO!
                        <button type="button" class="btn btn-sm btn-alt-secondary" data-toggle="tooltip"
                            data-placement="top" title="Nueva busqueda"
                            onclick="window.location='{{ route('inventory.report.removes.index') }}'"><i
