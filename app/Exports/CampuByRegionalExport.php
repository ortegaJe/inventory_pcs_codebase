...
class CampuByRegionalExport implements 
    FromCollection,
    ShouldAutoSize,
    //ShouldAutoSize,
    WithColumnWidths,
    ...
    WithCustomStartCell
{
    ...
    public function __construct(int $RegionalId, string $RegionalName)
    {
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->setAutoFilter('B3:L3');
                ...
                $event->sheet->getCell('B2')->setValue("INVENTARIO DE REGIONALES POR SEDE REGISTRADAS ".$this->RegionalName);
