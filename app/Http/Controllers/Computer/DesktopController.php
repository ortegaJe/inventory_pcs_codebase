...
{
    public function indexAdminDesktop(Request $request)
    {
    ...
    public function createAdminDesktop()
    {
    ...
    public function storeAdminDesktop(Request $request)
    {
        ...
        if ($validator->fails()) :
            ...
            if ($pc->save()) :
                return redirect()->route('admin.index.index_desktop')
    ...
    public function destroyAdminDesktop($id)
    {
        $pcs = null;
        $pcTemp = [];
