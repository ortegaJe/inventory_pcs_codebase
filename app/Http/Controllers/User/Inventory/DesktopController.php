...
class DesktopController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'location' => 'required|nullable|max:56|regex:/^[0-9a-zA-Z-ñ-Ñ-ó-Ó-í-Í ]+$/i',
            'custodian-assignment-date' => 'required_with:custodian-name,filled|max:10|date',
            'custodian-name' => 'required_with:custodian-assignment-date,filled|max:56|regex:/^[0-9a-zA-Z-ñ-Ñ-ó-Ó-í-Í .]+$/i',
