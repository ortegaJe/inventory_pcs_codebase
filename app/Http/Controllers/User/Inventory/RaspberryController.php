...
class RaspberryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $deviceType = Device::select('tp.name as type_name')->join('type_devices as tp', 'tp.id', 'devices.type_device_id')->where('devices.type_device_id', TypeDevice::RASPBERRY_PI_ID)->first();
