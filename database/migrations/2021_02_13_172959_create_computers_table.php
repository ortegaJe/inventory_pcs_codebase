...
class CreateComputersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('computers', function (Blueprint $table) {
            ...
            $table->char('serial_number')->unique(); //serial_number
            $table->char('monitor_serial_number')->nullable()->unique(); //monitor_serial_number
            ...
            $table->char('pc_image')->nullable()->unique();
